...
public class FragmentTileSet extends Fragment implements ITileDropTarget{

    private static final String TAG = FragmentTileSet.class.getSimpleName();
...
//        final View view = new LinearLayout(getContext());
    ...
    public static FragmentTileSet newInstance(TileSet tileSet) {
        FragmentTileSet fragment = new FragmentTileSet();
